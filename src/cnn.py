...
class SoundCNN(nn.Module):
    def __init__(self, input_shape=(1, 64, 800), num_classes=None):
        ...
        # The issue with MFCCs is that they have fewer frequency bins (20) compared to Mel (64)
        # This means we need to adjust our pooling strategy to avoid dimensions becoming too small
        ...
        in_time = input_shape[2]      # Typically 800
        ...
        self.pool3 = nn.AdaptiveMaxPool2d((4, 5))  # Force output to be 4x5 regardless of input
        
        # Calculate the flattened size based on the adaptive pooling output
        self.flatten_size = 128 * 4 * 5  # 128 channels x 4 x 5 = 2560
